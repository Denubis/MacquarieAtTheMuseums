...
<xsl:template match="/atom:feed">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://mqatthemuseums.com"> Macquarie at the Museums</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://mqatthemuseums.com" title="Macquarie at the Museums – News and Updates about the Macquarie at the Museums events">
				<img src="http://mqatthemuseums.com/assets/img/logo.png" alt="Macquarie at the Museums – News and Updates about the Macquarie at the Museums events">
			</a>
